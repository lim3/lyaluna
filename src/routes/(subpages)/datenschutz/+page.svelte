...
<section>
  <div class="container">
    <h1 class="title">Datenschutzverordnung</h1>
    <p>
    ...
    <p>
      ...
      beschweren. Eine Liste der entsprechenden Behörden finden Sie unter: <a
        target="_blank"
        rel="noreferrer"
    ...
    <p>
      ...
      Greenwich Mean Time, Inhalt der Anforderung, HTTP-Statuscode, übertragene
      Datenmenge, Website, von der die Anforderung kommt und Informationen zu
    ...
    <p>
      ...
      Zusammenfassung. Diese beinhaltet die Adresse der vorher besuchten Seite,
      die Häufigkeit der jeweils aufgerufenen Seiten und die Anzahl eindeutiger
    ...
    <p>
      ...
      gegenüber GitHub finden Sie unter: <a
        target="_blank"
        rel="noreferrer"
